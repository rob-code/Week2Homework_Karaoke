...
@guest5 = Guest.new("Bert", 1, 5, "Hey Hey Hey")
@guest6 = Guest.new("Ritchie", 1, 5, "Smoke on the Water")
...
def test_check_guest_into_room__fails_when_room_is_full
  @bar_manager.check_guest_into_room(@guest1)
  @bar_manager.check_guest_into_room(@guest2)
  @bar_manager.check_guest_into_room(@guest3)
  @bar_manager.check_guest_into_room(@guest4)
  @bar_manager.check_guest_into_room(@guest5)
  @bar_manager.check_guest_into_room(@guest6)
end
